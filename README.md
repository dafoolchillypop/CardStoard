...
|---------|------|-----------|
| **v1.19** | Apr 2026 | AI Image Recognition: photograph or upload a card — AI identifies player/brand/year/card number and pre-fills the Add Card form; camera capture in browser; dictionary expanded to 28,800+ entries (Topps 1952–1990 full checklist); dictionary data quality pass: bogus entries removed, rookie_year populated for 70+ HOF/star players |
